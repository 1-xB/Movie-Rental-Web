...
public static class AuthEndpoints {
	public static RouteGroupBuilder MapAuthRoutes(this WebApplication app) {
		...
		group.MapPost("/refresh-tokens",
			async (IAuthService authService, RefreshTokenRequestDto request, HttpContext http) => {
		...
		group.MapPost("/register-admin", [Authorize(Roles = "Admin")]
			async (HttpContext httpContext, IAuthService authService, UserRegisterDto request) => {
